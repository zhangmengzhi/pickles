...
<html>
    ...
    <script src="${base}/static/assets/js/photo-gallery.js"></script>
								...
								<div class="image-more">
									 <ul class="row">
										 <li class="col-lg-3 col-sm-3 col-xs-4">
											<a href="#"><img class="img-responsive" src="${base}/static/assets/images/galaxy-note.jpg"></a>
										</li>
										 <li class="col-lg-3 col-sm-3 col-xs-4">
											<a href="#"><img class="img-responsive" src="${base}/static/assets/images/galaxy-note-2.jpg"></a>
										</li>
										 <li class="col-lg-3 col-sm-3 col-xs-4">
											<a href="#"><img class="img-responsive" src="${base}/static/assets/images/galaxy-note-3.jpg"></a>
										</li>
										 <li class="col-lg-3 col-sm-3 col-xs-4">
											<a href="#"><img class="img-responsive" src="${base}/static/assets/images/galaxy-note-4.jpg"></a>
										</li>
									</ul>
								</div>
							</div>
			...
			<div class="wrap-footer">
				<div class="row">
					<div class="col-md-3 col-footer footer-1">
						<img src="${base}/static/assets/images/logofooter.png" />
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="pull-right">
							<ul>
								<li><img src="${base}/static/assets/images/visa-curved-32px.png" /></li>
								<li><img src="${base}/static/assets/images/paypal-curved-32px.png" /></li>
								<li><img src="${base}/static/assets/images/discover-curved-32px.png" /></li>
								<li><img src="${base}/static/assets/images/maestro-curved-32px.png" /></li>
							</ul>
						</div>
					</div>
				</div>
