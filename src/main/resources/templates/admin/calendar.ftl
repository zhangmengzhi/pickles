...
<html>
    <head>
		...
		<meta charset="utf-8" />
		<title>Full Calendar - pickles</title>
		...
		<link rel="stylesheet" href="${base}/static/assets/css/fullcalendar.css" />
	...
	<body>
		...
		<script src="${base}/static/assets/js/fullcalendar.min.js"></script>
