...
public class Group2 {
    ...
    public Group copyProperties(){
    	Group group = new Group();
    	
    	if(StringUtils.isNotBlank(this.getId())){
    		group.setId(Integer.parseInt(this.getId()));
    	}    	
    	group.setCode(this.getCode());
    	group.setGroupName(this.getGroupName());
    	group.setAdminName(this.getAdminName());
    	group.setPhone(this.getPhone());
    	group.setRegisterDate(this.getRegisterDate());
    	group.setStatus(this.getStatus());
    	group.setNote(this.getNote());
